...
## for convenience, several intermediate files that would have been generated by pipeline_cluster_survey.sh have been uploaded to github (under the 'data' directory)

## files
fname_table_s11 <- "/path/to/table/s11.tsv" ## extract table S11 to tab-separated file and update path accordingly
fname_final_genes <- "/path/to/nlr164_final_wPred_newClust.tsv" ## download nlr164_final_wPred_newClust.tsv from the github repo and update accordingly
...
genes <- read.table(fname_final_genes,
                    sep = '\t', header = TRUE, stringsAsFactors = FALSE) %>%
...
dat_pops_clade <- read.table(paste0(dir_results, "/popg_test/clades/nlr164_NB-ARC_CDSonly_clade_stats.tsv"),
                             sep = '\t', header = TRUE, stringsAsFactors = FALSE) %>%
